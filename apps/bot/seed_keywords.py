...
_SEED: list[tuple[str, str, str, int, int, str | None]] = [
    ...
    ("jasper ai vs chatgpt for writing", "ai-writing", "comparison", 4400, 38, "jasper"),
    ...
    ("ai writing tools for bloggers", "ai-writing", "informational", 2100, 28, "jasper"),
    ("best ai tools for content marketing", "ai-writing", "informational", 4500, 40, "jasper"),
    # ai-writing — tutorial
    ...
    ("ai voice cloning tools comparison", "ai-video", "comparison", 2900, 28, "elevenlabs"),
    ...
    ("elevenlabs voice cloning tutorial", "ai-video", "tutorial", 2200, 20, "elevenlabs"),
    # ai-code — comparison
    ...
    ("best ai productivity tools 2026", "ai-productivity", "comparison", 6600, 35, None),
    ("notion ai vs chatgpt", "ai-productivity", "comparison", 3200, 30, None),
    ("best ai meeting assistants 2026", "ai-productivity", "comparison", 3400, 30, None),
    ...
    ("zapier ai features explained", "ai-productivity", "informational", 2100, 25, None),
